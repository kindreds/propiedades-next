          ...
          <Container maxW="container.lg" py={5}>
            <Stack spacing={5}>
              ...
              >
                ...
                <Text>
                  Los asesores RE / MAX trabajan de forma autónoma, pero no
                  están solos. Cuentan con el apoyo del Broker y de toda la
                  Organización RE / MAX, reconocida en todo el mundo por
                  desarrollar su propia cartera de clientes a cambio de las
                  comisiones más altas del mercado. <br /> <br /> El asesor RE /
                  MAX tiene todo lo que necesita para disfrutar de una carrera
                  exitosa. Entrenamiento constante, tecnología revolucionaria,
                  comisiones máximas y crecimiento constante. En RE / MAX, el
                  único límite es su propia capacidad de trabajo.
                </Text>
              </Box>
              <Box
                p={8}
